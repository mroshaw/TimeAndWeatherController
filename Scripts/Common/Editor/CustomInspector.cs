...
using DaftAppleGames.Editor.PropertyDrawers;
    ...
    public class CustomInspector : UnityEditor.Editor
    {
        ...
        protected void DrawSerializedProperties()
        {
            ...
            foreach (var property in GetNonGroupedProperties(_serializedProperties))
            {
                ...
                {
                    CustomEditorGUI.PropertyField_Layout(property, includeChildren: true);
                }
            }
            ...
            foreach (var group in GetGroupedProperties(_serializedProperties))
            {
                ...
                CustomEditorGUI.BeginBoxGroup_Layout(group.Key);
                foreach (var property in visibleProperties)
                {
                    CustomEditorGUI.PropertyField_Layout(property, includeChildren: true);
                }

                CustomEditorGUI.EndBoxGroup_Layout();
            }
        ...
        protected void DrawNonSerializedFields(bool drawHeader = false)
        {
            if (_nonSerializedFields.Any())
            {
                if (drawHeader)
                {
                    ...
                    CustomEditorGUI.HorizontalLine(
                ...
                {
                    CustomEditorGUI.NonSerializedField_Layout(serializedObject.targetObject, field);
                }
            }
        }
        ...
        protected void DrawNativeProperties(bool drawHeader = false)
        {
            if (_nativeProperties.Any())
            {
                ...
                {
                    CustomEditorGUI.NativeProperty_Layout(serializedObject.targetObject, property);
                }
            }
        }
