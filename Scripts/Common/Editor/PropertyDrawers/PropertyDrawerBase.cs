...
using DaftAppleGames.Editor.PropertyValidators;
using DaftAppleGames.Editor.Utility;
using UnityEditor;
using UnityEngine;

namespace DaftAppleGames.Editor.PropertyDrawers
{
    public abstract class PropertyDrawerBase : PropertyDrawer
    {
        ...
        {
            float indentLength = CustomEditorGUI.GetIndentLength(rect);
            ...
            CustomEditorGUI.HelpBox(helpBoxRect, message, MessageType.Warning, context: property.serializedObject.targetObject);
